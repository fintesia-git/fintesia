        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Presencia global, con un solo click - Fintesia se encarga del resto
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Conozca el comportamiento de sus clientes y mejore su experiencia, sin sacrificar la privacidad de sus datos. Usando herramientas como Google Analytics, Meta Pixel, y más. 
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Redes & Networking</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Posea presencia desde el minuto 0 en las aplicaciones que liderarán el futuro, posicionandose como líder en el mercado digital.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Mejore su exposición en los motores de búsqueda, con la optimización de su sitio web para que sea más visible y accesible para los usuarios.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Desarrollo customizado</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Desarrollamos soluciones personalizadas para que su negocio crezca y se distinga en el mercado. Desde aplicaciones web hasta software empresarial.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Utilize herramientas de localización para mejorar su presencia en el mundo real. Identifique su audiencia y optimice su plataforma digital.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Mantenga su imagen actualizada con las últimas tendencias y tecnologías. Atraiga a más clientes con una experiencia digital innovadora.
              </p>
            </article>
          </div>
        </div>
